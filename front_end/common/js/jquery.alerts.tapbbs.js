...
(function($) {
	...
	$.alerts = {
		...
		_show: function(title, msg, value, type, callback) {
            ...
            var width = {
                min : (win_width > 600) ? 300 : 250,
                max : (win_width > 600) ? 300 : 250
            };
			...
			switch( type ) {
				case 'alert':
					...
					if($.browser.msie && parseInt($.browser.version) <= 8) //IE 7,8 과 jquerymobile에서 focus 문제가 있어서 죽인다. KangMin 2012.03.10
					{
					}
					else
					{
